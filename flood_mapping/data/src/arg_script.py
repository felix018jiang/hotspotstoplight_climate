...
file_path = os.path.join(os.path.dirname(__file__), '../../data/inputs/argentina_aoi/geoBoundaries-ARG-ADM0_simplified.geojson')
...
process_flood_data(absolute_path, date_pairs, 'argentina')