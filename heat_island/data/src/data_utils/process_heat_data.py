...
def process_heat_data(place_name):
   ...
   # Split the data into training and testing
    ...
    squared_difference = recent_image.select('median_top5').subtract(predicted_image).pow(2).rename('difference')
    ...
    task = start_export_task(classified_image, f'{place_name} Median temp of top 5 hottest observations', bucket_name, directory_name + predicted_image_filename, scale)
    tasks = [task]
